...
const PRECACHE_LIST = [
  ...
  "./index.html",
  "./nl/index.html",
  "./nl/content/technologie.html",
  "./nl/content/projecten.html",
  "./nl/content/vacantures.html",
  "./nl/content/newsletter.html",
  "./nl/content/schedule.html",
  "./nl/content/privacy.html",
  "./nl/content/terms.html",
  "./404.html",
  ...
  "./assets/css/min/footer.min.css",
  "./assets/css/min/service.min.css",
  "./assets/css/min/team.min.css",
  "./assets/css/min/image-hover.css",
  "./assets/css/min/careers.min.css",
  "./assets/css/min/color.min.css",
  "./assets/css/min/technology.min.css",
  "./assets/css/min/color.min.css",
